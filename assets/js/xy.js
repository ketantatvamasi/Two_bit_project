...
(self.webpackChunk_am5 = self.webpackChunk_am5 || []).push([[6450], {
    6901: function (e, t, i) {
        ...
        var a = i(5125), r = i(55), n = i(8777), o = i(7142), s = i(5829), l = i(7144), u = i(6245), h = i(1112),
            c = i(8054), p = i(1479), b = i(5071), d = i(5040), g = i(3540), f = i(256), m = i(7652), v = function (e) {
                function t() {
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function (e) {
                        var t = this, i = this.get("wheelX"), a = this.get("wheelY"), r = this.plotContainer,
                            n = e.originalEvent;
                        if (m.isLocalEvent(n, this)) {
                            n.preventDefault();
                            var o = r.toLocal(this._root.documentPointToRoot({x: n.clientX, y: n.clientY})),
                                s = this.get("wheelStep", .2), l = n.deltaY / 100, u = n.deltaX / 100,
                                h = this.get("wheelZoomPositionX"), c = this.get("wheelZoomPositionY");
                            "zoomX" !== i && "zoomXY" !== i || 0 == u || this.xAxes.each((function (e) {
                                if (e.get("zoomX")) {
                                    var i = e.get("start"), a = e.get("end"), n = e.fixPosition(o.x / r.width());
                                    null != h && (n = h);
                                    var l = i - s * (a - i) * u * n, c = a + s * (a - i) * u * (1 - n);
                                ...
                                if (e.get("zoomX")) {
                                    var i = e.get("start"), a = e.get("end"), n = e.fixPosition(o.x / r.width());
                                    null != h && (n = h);
                                    var u = i - s * (a - i) * l * n, c = a + s * (a - i) * l * (1 - n);
                                ...
                                if (e.get("zoomY")) {
                                    var i = e.get("start"), a = e.get("end"), n = e.fixPosition(o.y / r.height());
                                    null != c && (n = c);
                                    var l = i - s * (a - i) * u * n, h = a + s * (a - i) * u * (1 - n);
                                ...
                                if (e.get("zoomY")) {
                                    var i = e.get("start"), a = e.get("end"), n = e.fixPosition(o.y / r.height());
                                    null != c && (n = c);
                                    var u = i - s * (a - i) * l * n, h = a + s * (a - i) * l * (1 - n);
                                ...
                                if (e.get("panX")) {
                                    var i = e.get("start"), a = e.get("end"), r = t._getWheelSign(e) * s * (a - i) * u,
                                        n = i + r, o = a + r, l = t._fixWheel(n, o);
                                    n = l[0], o = l[1], t._handleWheelAnimation(e.zoom(n, o))
                                }
                            })), "panX" !== a && "panXY" !== a || 0 == l || this.xAxes.each((function (e) {
                                if (e.get("panX")) {
                                    var i = e.get("start"), a = e.get("end"), r = t._getWheelSign(e) * s * (a - i) * l,
                                        n = i + r, o = a + r, u = t._fixWheel(n, o);
                        ...
                        if (f.each(o._downPoints, (function (e, t) {
                            ...
                            if (p && b && d && g) {
                                ...
                                if (this.get("pinchZoomY")) {
                                    var T = this._downStartY, D = this._downEndY;
                                    if (null != T && null != D) {
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        if (this.series.each((function (a) {
                            ...
                            var y = this._root.tooltipContainer, _ = l.length;
                            if (h / _ > n / 2 + o.y) {
                                l.sort((function (e, t) {
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "setupDefaultRules", {
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        r("XYChart").setAll({
                            ...
                            pinchZoomX: !1,
                            pinchZoomY: !1
                        }), r("XYSeries").setAll({legendLabelText: "{name}"}), r("XYChart", ["scrollbar", "chart"]).setAll({
                            paddingBottom: 0,
                            paddingLeft: 0,
                            paddingTop: 0,
                            paddingRight: 0,
                            ...
                            fillRule: function (e) {
                                ...
                                if (i) {
                                    var a = e.component, r = e.get("value"), n = e.get("endValue"),
                                        ...
                                        u = a.getPrivate("gridInterval", s), h = a.getPrivate("min", 0);
                        ...
                        if (this._downPoint) {
                            ...
                            if ("none" != t) {
                                ...
                                var i = this._root.documentPointToRoot({x: e.clientX, y: e.clientY}),
                                    a = this._display.toLocal(i), r = this._downPoint, n = this.get("moveThreshold", 1);
                                if (a && r) {
                                    var o = !1;
        ...
        var a = i(5125), r = i(9361), n = i(8777), o = i(6245), s = i(7144), l = i(7142), u = i(5071), h = i(5040),
            c = i(7652), p = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_dispose", {
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function (e, t, i, r) {
                        var n, o = this;
                        if (this.get("start") !== e || this.get("end") != t) {
                            ...
                            var c = this.getPrivate("maxZoomFactor", this.get("maxZoomFactor", 100)), p = c;
                            1 === t && 0 !== e && (r = e < this.get("start") ? "start" : "end"), 0 === e && 1 !== t && (r = t > this.get("end") ? "end" : "start");
                            var b = this.get("minZoomCount"), d = this.get("maxZoomCount");
                            h.isNumber(b) && (c = p / b);
                            var g = 1;
                    ...
                    value: function () {
                        ...
                        if (!e.isHidden()) {
                            var t = e.localBounds(), i = t.right - t.left, a = e.get("text");
                        ...
                        var r = this.get("start", 0), n = this.get("end", 1);
        ...
        var a = i(5125), r = i(6275), n = i(6245), o = i(5040), s = i(7652), l = i(7142), u = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return Object.defineProperty(t, "thumb", {
                    ...
                    configurable: !0,
                    writable: !0,
                    value: l.A.new(t._root, {width: n.AQ, isMeasured: !1, themeTags: ["axis", "x", "thumb"]})
                }), t
            }
            ...
            return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                ...
                value: function (e, t, i, a) {
                    if (e) {
                        ...
                        var s = e.get("length", 0), l = e.get("inside", this.get("inside", !1));
                ...
                value: function (e, t, i) {
                    ...
                    e.set("draw", (function (e) {
                        var n, o = r.axis.gridContainer.height(), s = r.width();
        ...
        var a = i(5125), r = i(6275), n = i(6245), o = i(5040), s = i(7652), l = i(7142), u = function (e) {
            function t() {
                ...
                return Object.defineProperty(t, "_downY", {
                    ...
                    configurable: !0,
                    writable: !0,
                    value: l.A.new(t._root, {height: n.AQ, isMeasured: !1, themeTags: ["axis", "y", "thumb"]})
                }), t
            }
            ...
            return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                ...
                value: function () {
                    ...
                    var t = this.axis;
                    t.ghostLabel.setPrivate("visible", !this.get("inside"));
                    var i = this.thumb, a = "opposite", r = "inside", n = this.chart;
                ...
                value: function (e, t, i, a) {
                    if (e) {
                        ...
                        var n = this.get("opposite"), s = e.get("inside", this.get("inside", !1));
                ...
                value: function (e, t, i, a) {
                    if (e) {
                        ...
                        var n = e.get("length", 0), s = e.get("inside", this.get("inside", !1));
                ...
                value: function (e, t, i) {
                    var r = this;
                    e.set("draw", (function (e) {
                        var n, o = r.axis.gridContainer.width(), s = r.height();
        ...
        var a = i(5125), r = i(9361), n = i(7261), o = i(5040), s = i(3540), l = i(5071), u = i(256), h = i(7652),
            c = i(1926), p = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    value: function () {
                        ...
                        null != e ? this.setPrivateRaw("maxZoomFactor", e) : this.setPrivateRaw("maxZoomFactor", Math.round((this.getPrivate("max", 0) - this.getPrivate("min", 0)) / this.baseMaipositionmnDuration()))
                    }
                        ...
                        if (o.isNumber(t) && o.isNumber(i)) {
                            ...
                            if (this.isDirty("groupData") && !this._dataGrouped) {
                                if (this.get("groupData")) l.each(this.series, (function (t) {
                                    ...
                                    var n = this.get("baseInterval"), s = n.timeUnit + n.count;
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function (e) {
                        ...
                        if (this.get("groupData") && !e.get("groupDataDisabled")) {
                            ...
                            var i = [], a = this.baseMainDuration(), n = this.get("groupIntervals");
                            l.each(n, (function (e) {
                            ...
                            var b = e._mainDataItems, d = this.get("baseInterval"), g = d.timeUnit + d.count;
                            e._dataSets[g] = b;
                            var f = e.get("groupDataCallback"), m = e.get("groupDataWithOriginals", !1);
                            f && (m = !0), l.each(i, (function (i) {
                                var a, n = -1 / 0, p = i.timeUnit + i.count;
                                e._dataSets[p] = [];
                                var d = {}, g = {}, v = {}, y = {};
                                l.each(s, (function (t) {
                        ...
                        if (o.isNumber(i) && o.isNumber(a)) {
                            ...
                            l.each(this.series, (function (e) {
                                if (e.get("baseAxis") === t) {
                                    ...
                                    u > 0 && u--;
                                    var h = e.dataItems[n], c = e.dataItems[u], p = void 0, b = void 0;
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        if (o.isNumber(e) && o.isNumber(t)) {
                            var i = Math.round(this.getPrivate("selectionMin")),
                                n = Math.round(this.getPrivate("selectionMax")), s = this.get("renderer"),
                                u = this.getPrivate("baseInterval"), h = i, p = 0, b = this.get("gridIntervals"),
                            ...
                            var f = c.getNextUnit(d.timeUnit),
                                ...
                                v = void 0, y = this.get("dateFormats");
                    ...
                    value: function (e, t) {
                        var i = this.getPrivate("name") + this.get("renderer").getPrivate("letter"),
                            a = this.positionToValue(t), r = l.getSortedIndex(e.dataItems, (function (e) {
                                var t = 0;
        ...
        var a = i(5125), r = i(5638), n = i(9361), o = i(5071), s = i(3540), l = i(1926), u = i(5040),
            h = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    writable: !0,
                    value: function (e) {
                        var t = this._dates, i = o.getSortedIndex(t, (function (t) {
                            return s.qu(t, e)
                        }));
                    ...
                    writable: !0,
                    value: function (e) {
                        var t = this._dates, i = t.length, a = o.getSortedIndex(t, (function (t) {
                            return s.qu(t, e)
                        })), r = a.index;
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        if (u.isNumber(t) && u.isNumber(i)) {
                            ...
                            var r = this._dates, s = this.get("renderer"), h = r.length, c = this.valueToIndex(t);
                            c > 0 && c--;
                            ...
                            var m = i - t - ((i - t) / this.baseDuration() - (p - c)) * this.baseDuration(),
                                ...
                                y = this.getPrivate("baseInterval"), _ = l.getIntervalDuration(v);
                            _ < this.baseDuration() && (v = (0, a.pi)({}, y), _ = l.getIntervalDuration(v)), this._intervalDuration = _;
                            var x = this.get("dateFormats"), w = [], P = new Date;
                            ...
                            for (var O = l.round(new Date(this.getPrivate("min", 0)), v.timeUnit, v.count, this._root.locale.firstDayOfWeek, this._root.utc, P, this._root.timezone), T = l.add(O, v.timeUnit, -1, this._root.utc, this._root.timezone).getTime(), D = this.getPrivate("selectionMax"), j = -1 / 0, A = (this.get("end", 1) - this.get("start", 0)) / b; T <= D;) {
                                var k = this.valueToIndex(T), I = this._dates[k];
                                if (I < T) for (var M = k, C = this._dates.length; M < C; M++) if (this._dates[M] >= T) {
                                    k = M;
                                    break
                                }
        ...
        var a = i(5125), r = i(9361), n = i(6515), o = i(7449), s = i(5040), l = i(5071), u = i(751), h = i(7652),
            c = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "markDirtyExtremes", {
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        if (s.isNumber(e) && s.isNumber(t)) {
                            var i = this.get("logarithmic"), a = this.getPrivate("step"),
                                n = this.getPrivate("selectionMin"), o = this.getPrivate("selectionMax") + a, h = n - a,
                                c = 0, p = 1, b = e;
                            if (i) {
                    ...
                    value: function (e, t) {
                        var i = this.get("renderer"), a = e.get("value"), r = e.get("endValue"),
                            n = this.valueToPosition(a), o = n, l = this.valueToPosition(a + this.getPrivate("step"));
                    ...
                    value: function () {
                        var e = this.positionToValue(this.get("start", 0)),
                            t = this.positionToValue(this.get("end", 1)), i = this.get("renderer").gridCount(),
                            a = this._adjustMinMax(e, t, i, !0), r = h.decimalPlaces(a.step);
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        var e, t = this, i = this.getPrivate("minFinal"), r = this.getPrivate("maxFinal"),
                            n = this.get("min"), o = this.get("max"), h = this.get("extraMin", 0),
                            c = this.get("extraMax", 0);
                        this.get("logarithmic") && (null == this.get("extraMin") && (h = .1), null == this.get("extraMax") && (c = .2));
                        var p = this.get("renderer").gridCount(), b = this.get("strictMinMaxSelection"),
                            d = this.get("strictMinMax");
                        if (s.isNumber(i) && s.isNumber(r)) {
                            var g = r, f = i;
                            if (l.each(this.series, (function (e) {
                                if (!e.get("ignoreMinMax")) {
                                    var i = void 0, a = void 0, r = e.getPrivate("outOfSelection");
                            ...
                            var w = this.valueToFinalPosition(g), P = this.valueToFinalPosition(f);
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        if (0 === a && 0 === r && (r = .9, a = -.9), s.isNumber(t) && (a = t), s.isNumber(i) && (r = i), a !== 1 / 0 && r !== -1 / 0) {
                            var c = a, p = r, b = this.adapters.fold("min", a), d = this.adapters.fold("max", r);
                            ...
                            var g = this.get("strictMinMax"), f = this.get("strictMinMaxSelection", !1);
                            f && (g = f);
                            var m = g;
                            s.isNumber(i) && (m = !0);
                            var v = this.get("renderer").gridCount(), y = this._adjustMinMax(a, r, v, m);
                            ...
                            if (_ && (y = this._syncAxes(a, r, y.step, _.getPrivate("minFinal", _.getPrivate("min", 0)), _.getPrivate("maxFinal", _.getPrivate("max", 1)), _.getPrivate("step", 1)), a = y.min, r = y.max), this.setPrivateRaw("maxZoomFactor", (r - a) / u * this.get("maxZoomFactor", 100)), this.get("logarithmic") && (this._minLogAdjusted = a, a = this._minReal, r = this._maxReal, a <= 0 && (a = c * (1 - Math.min(n, .99)))), s.isNumber(a) && s.isNumber(r) && (this.getPrivate("minFinal") !== a || this.getPrivate("maxFinal") !== r)) {
                                ...
                                var x = this.get("interpolationDuration", 0), w = this.get("interpolationEasing");
                                this.animatePrivate({
                                    key: "min",
                                    to: a,
                                    duration: x,
                                    easing: w
                                }), this.animatePrivate({key: "max", to: r, duration: x, easing: w})
                            }
                        }
                    }
                }), Object.defineProperty(t.prototype, "_getDelta", {
                    ...
                    writable: !0,
                    value: function (e) {
                        var t = Math.log(Math.abs(e)) * Math.LOG10E, i = Math.pow(10, Math.floor(t));
                    ...
                    value: function (e, t, i, a) {
                        ...
                        var r = e, n = t, o = t - e;
                        0 === o && (o = Math.abs(t));
                        var l = Math.log(Math.abs(o)) * Math.LOG10E, h = Math.pow(10, Math.floor(l)), c = h /= 10;
                        ...
                        var p = Math.ceil(o / i / h) * h,
                            b = Math.pow(10, Math.floor(Math.log(Math.abs(p)) * Math.LOG10E)), d = Math.ceil(p / b);
                    ...
                    value: function (e) {
                        var t = this.get("tooltipNumberFormat", this.get("numberFormat")),
                            i = this.getNumberFormatter(), a = this.get("extraTooltipPrecision", 0),
                            r = this.getPrivate("stepDecimalPlaces", 0) + a, n = u.round(this.positionToValue(e), r);
                    ...
                    value: function (e, t, i, a, r, n) {
                        if (this.get("syncWithAxis")) {
                            var o = Math.round(r - a) / n, l = Math.round((t - e) / i),
                                u = this.get("renderer").gridCount();
                            if (s.isNumber(o) && s.isNumber(l)) for (var h = !1, c = 0, p = .01 * (t - e), b = e, d = t, g = i; 1 != h;) if (h = this._checkSync(b, d, g, o), ++c > 500 && (h = !0), h) e = b, t = d, i = g; else {
                    ...
                    writable: !0,
                    value: function (e, t, i, a) {
                        for (var r = (t - e) / i, n = 1; n < a; n++) if (u.round(r / n, 1) == a || r * n == a) return !0;
                        return !1
                    }
                }), Object.defineProperty(t, "className", {
                    enumerable: !0,
        ...
        var a = i(5125), r = i(4604), n = i(6245), o = i(1479), s = i(5071), l = i(5040), u = function (e) {
            ...
            return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_makeGraphics", {
                    ...
                    if (this._aLocationX0 = f + u / h * (m - f), this._aLocationX1 = f + (u + 1) / h * (m - f), this._aLocationY0 = v + u / h * (y - v), this._aLocationY1 = v + (u + 1) / h * (y - v), r.inited && n.inited) {
                        if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty) {
                            ...
                            for (var O = this.dataItems[x], T = x; T <= w; T++) if (null != (k = this.dataItems[T]).get("valueX") && null != k.get("valueY")) {
                                if (O = k, T > 0 && x > 0) for (var D = T - 1; D >= 0; D--) {
                ...
                enumerable: !1, configurable: !0, writable: !0, value: function (e, t) {
                    var i = this, a = e.get("graphics"), r = this._xField, o = this._yField, u = e.get(r), h = e.get(o);
                    if (null != u && null != h) {
                        var c, p, b, d, g = this._xOpenField, f = this._yOpenField,
                            ...
                            _ = this.get("openLocationY", e.get("openLocationY", v)), x = a.get("width"),
                            w = a.get("height"), P = this.get("stacked"), O = this.get("xAxis"), T = this.get("yAxis"),
                            D = this.get("baseAxis"), j = O.get("start"), A = O.get("end"), k = T.get("start"),
                            I = T.get("end"), M = this.get("vcy", 1), C = this.get("vcx", 1), Y = !1, X = !1;
                        if (T.isType("CategoryAxis") && O.isType("CategoryAxis")) {
                            var S = this._aLocationX0 + y - .5, F = this._aLocationX1 + m - .5;
                            ...
                            if (S = this._aLocationX0 + y - .5, F = this._aLocationX1 + m - .5, x instanceof n.gG && (S += R = (F - S) * (1 - x.value) / 2, F -= R), c = O.getDataItemPositionX(e, g, S, C), p = O.getDataItemPositionX(e, r, F, C), b = T.getDataItemPositionY(e, o, v, M), this._yOpenField !== this._yField) d = T.getDataItemPositionY(e, f, _, M); else if (P) {
                            ...
                            var R;
                            if (S = this._aLocationY0 + _ - .5, F = this._aLocationY1 + v - .5, w instanceof n.gG && (S += R = (F - S) * (1 - w.value) / 2, F -= R), b = T.getDataItemPositionY(e, f, S, M), d = T.getDataItemPositionY(e, o, F, M), p = O.getDataItemPositionX(e, r, m, C), this._xOpenField !== this._xField) c = O.getDataItemPositionX(e, g, y, C); else if (P) {
        ...
        var a = i(5125), r = i(3497), n = function (e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
            }
        ...
        var a = i(5125), r = i(62), n = i(2976), o = i(5769), s = i(7144), l = i(7652), u = i(5071), h = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return Object.defineProperty(t, "columns", {
                    ...
                    configurable: !0,
                    writable: !0,
                    value: new s.o(o.YS.new({themeTags: ["autocolor"]}), (function () {
                        return n.j._new(t._root, {themeTags: l.mergeTags(t.columns.template.get("themeTags", []), ["candlestick", "series", "column"])}, [t.columns.template])
                    }))
                }), t
            }
            ...
            return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "makeColumn", {
                ...
                value: function (e, t, i, a, r, n, o, s, l, h) {
                    ...
                    if (c) {
                        var p = this.getPoint(t, a), b = this.getPoint(i, r), d = this.getPoint(n, s),
                            g = this.getPoint(o, l), f = c.x(), m = c.y();
                ...
                value: function (t) {
                    ...
                    e.prototype._processAxisRange.call(this, t), t.columns = new s.o(o.YS.new({}), (function () {
                        return n.j._new(i._root, {themeTags: l.mergeTags(t.columns.template.get("themeTags", []), ["candlestick", "series", "column"])}, [i.columns.template, t.columns.template])
                    }))
                }
            }), Object.defineProperty(t, "className", {
                enumerable: !0,
        ...
        var a = i(5125), r = i(757), n = i(5769), o = i(7144), s = i(3497), l = i(7652), u = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return Object.defineProperty(t, "columns", {
                    enumerable: !0,
        ...
        var a = i(5125), r = i(4604), n = i(1479), o = i(774), s = i(3794), l = i(5769), u = i(7144), h = i(1112),
            c = i(9361), p = i(7142), b = i(5040), d = i(5071), g = i(7652), f = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return Object.defineProperty(t, "_endIndex", {
                        ...
                        value: new u.o(l.YS.new({}), (function () {
                            return n.T._new(t._root, {themeTags: g.mergeTags(t.strokes.template.get("themeTags", []), ["line", "series", "stroke"])}, [t.strokes.template])
                        }))
                        ...
                        writable: !0,
                        value: new u.o(l.YS.new({}), (function () {
                            return n.T._new(t._root, {themeTags: g.mergeTags(t.strokes.template.get("themeTags", []), ["line", "series", "fill"])}, [t.fills.template])
                        }))
                        ...
                        writable: !0,
                        value: 0
                    }), Object.defineProperty(t, "_sindex", {enumerable: !0, configurable: !0, writable: !0, value: 0}), t
                }
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        if (t.inited && i.inited) {
                            if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty || this.isDirty("connect") || this.isDirty("curveFactory")) {
                                ...
                                var l = this.startIndex(), u = this.strokes.template.get("templateField"),
                                    h = this.fills.template.get("templateField"), c = !0, p = !0;
                                u && (c = !1), h && (p = !1);
                                ...
                                if (l > 0 && l--, this._endIndex = y, this._clearGraphics(), this._sindex = 0, this._dindex = l, 1 == this.dataItems.length) this._startSegment(0); else for (; this._dindex < y - 1;) this._startSegment(this._dindex), this._sindex++
                            }
                        } else this._skipped = !0;
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function (e) {
                        var t = this, i = this._endIndex, a = i, r = this.get("autoGapCount"), n = this.get("connect"),
                            o = this.makeFill(this.fills), s = this._fillTemplate, u = this.fills.template;
                        s && s != u && (o.template = s), o.setPrivate("visible", !0);
                        var h = this.makeStroke(this.strokes), c = this._strokeTemplate;
                        c && c != this.strokes.template && (h.template = c), h.setPrivate("visible", !0);
                        var p = this.get("xAxis"), b = this.get("yAxis"), d = this.get("baseAxis"), g = this.get("vcx", 1),
                            f = this.get("vcy", 1), m = this._xField, v = this._yField, y = this._xOpenField,
                            _ = this._yOpenField, x = this.get("openValueXField"), w = this.get("openValueYField");
                        x || (y = this._xField), w || (_ = this._yField);
                        var P, O = this.get("stacked"), T = p.basePosition(), D = b.basePosition();
                        P = d === b ? this._yField : this._xField;
                        var j = [], A = [];
                        j.push(A);
                        var k, I = this.strokes.template.get("templateField"), M = this.fills.template.get("templateField"),
                            C = this.get("locationX", .5), Y = this.get("locationY", .5), X = this.get("openLocationX", C),
                            S = this.get("openLocationY", Y), F = this.get("minDistance", 0),
                        ...
                        for (k = e; k < a; k++) {
                            this._dindex = k;
                            var V = this._dataItems[k], G = V.get(m), U = V.get(v);
                        ...
                        o.setRaw("userData", [e, k]), h.setRaw("userData", [e, k]), k === i && this._endLine(A, j[0][0]), h && this._drawStroke(h, j), o && this._drawFill(o, j), this.axisRanges.each((function (i) {
                            var a = i.container, r = i.fills, n = t.makeFill(r);
                            a && a.children.push(n), n.setPrivate("visible", !0), t._drawFill(n, j);
                            var o = i.strokes, s = t.makeStroke(o);
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function (e, t) {
                        ...
                        if (this._shouldInclude(n)) {
                            var s = this.getPoint(n, o), l = [s.x, s.y];
                            if (s.x += this._x, s.y += this._y, e.set("point", s), t.fillVisible) {
                                ...
                                if (t.baseAxis === t.xAxis ? h = t.basePosY : t.baseAxis === t.yAxis && (u = t.basePosX), t.getOpen) {
                                    var c = e.get(t.xOpenField), p = e.get(t.yOpenField);
                                    if (null != c && null != p) {
                            ...
                            if (t.minDistance > 0) {
                                var y = l[0], _ = l[1], x = l[2], w = l[3], P = this._previousPoint, O = P[0], T = P[1],
                                    D = P[2], j = P[3];
                    ...
                    value: function (t) {
                        ...
                        e.prototype._processAxisRange.call(this, t), t.fills = new u.o(l.YS.new({}), (function () {
                            return n.T._new(i._root, {themeTags: g.mergeTags(t.fills.template.get("themeTags", []), ["line", "series", "fill"])}, [i.fills.template, t.fills.template])
                        })), t.strokes = new u.o(l.YS.new({}), (function () {
                            return n.T._new(i._root, {themeTags: g.mergeTags(t.strokes.template.get("themeTags", []), ["line", "series", "stroke"])}, [i.strokes.template, t.strokes.template])
                        }))
                    }
        ...
        var a = i(5125), r = i(9361), n = i(3399), o = i(7144), s = i(8777), l = i(1479), u = i(5040), h = i(256),
            c = i(5071), p = i(7652), b = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    value: function () {
                        var e = this.get("xAxis"), t = this.get("yAxis"), i = e.getPrivate("name"),
                            a = p.capitalizeFirst(i), r = t.getPrivate("name"), n = p.capitalizeFirst(r),
                            o = e.get("renderer").getPrivate("letter"), s = t.get("renderer").getPrivate("letter"),
                            l = "open", u = "low", h = "high", c = "Show";
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        var i, a, r = this.get("xAxis"), n = this.get("yAxis"), o = this.get("baseAxis");
                        ...
                        if (this.isDirty("stacked") && (s ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()), this._valuesDirty && !this._dataProcessed && (this._dataProcessed = !0, s && this._stack(), c.each(this.dataItems, (function (e) {
                            ...
                            var l = this.startIndex(), u = this.endIndex(), h = this.get("minBulletDistance", 0);
                    ...
                    value: function () {
                        ...
                        var o = this._couldStackTo.length, s = 0, l = this.get("stackToNegative");
                        this._reallyStackedTo = {}, c.each(this.dataItems, (function (a) {
                            for (var r = 0; r < o; r++) {
                                var n = i._couldStackTo[r], h = n.dataItems[s], c = a.get(e);
                                if (h) {
                                    var p = h.get(e);
                                    if (l) {
                                ...
                                switch (a.label) {
                                    case 0:
                                        return r = [e.prototype.hideDataItem.call(this, t, i)], n = this.states.create("hidden", {}), u.isNumber(i) || (i = n.get("stateAnimationDuration", this.get("stateAnimationDuration", 0))), o = n.get("stateAnimationEasing", this.get("stateAnimationEasing")), s = this.get("xAxis"), l = this.get("yAxis"), h = this.get("baseAxis"), p = this.get("stacked"), h !== s && h || c.each(this._valueYFields, (function (e) {
                                            var a = l.getPrivate("min"), n = l.baseValue();
                    ...
                    value: function (e) {
                        ...
                        if (t) if (this.isHidden()) this.hideTooltip(); else if (t._setDataItem(e), e) {
                            var i = this.get("locationX", 0), a = this.get("locationY", 1), r = e.get("locationX", i),
                                n = e.get("locationY", a), o = this.get("xAxis"), s = this.get("yAxis"),
                                l = this.get("vcx", 1), u = this.get("vcy", 1),
                    ...
                    value: function (e, t) {
                        var i = this.get("xAxis").get("renderer").positionToCoordinate(e),
                            a = this.get("yAxis").get("renderer").positionToCoordinate(t), r = 999999999;
        ...
        var a = i(6901), r = i(5125), n = i(6001), o = i(1479), s = i(7652), l = function (e) {
            ...
            }(n.L), u = i(3355), h = i(757), c = i(6515), p = i(5071), b = i(5040), d = i(751), g = i(2132),
            f = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return Object.defineProperty(t, "_frequency", {
                ...
                return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    writable: !0,
                    value: function (e, t, i) {
                        var a = this.get("renderer"), r = e.get("categoryLocation", 0),
                            n = e.get("endCategoryLocation", 1), o = e.get("index");
                ...
                return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    enumerable: !1, configurable: !0, writable: !0, value: function () {
                        ...
                        var d = m.chooseInterval(0, c, o, this.get("gridIntervals")), g = m.getNextUnit(d.timeUnit),
                        ...
                        for (var v, y = this.get("dateFormats"), _ = -1 / 0, x = -1 / 0, w = -1 / 0, P = [], O = !1, T = a; T < n; T++) {
                            var D = this.dataItems[T], j = D.get("index"), A = !1, k = Number(D.get("category")),
                                I = new Date(k), M = m.getUnitValue(I, d.timeUnit);
                            v = y[d.timeUnit];
                            var C = !1;
            ...
            }(f), y = i(5638), _ = i(8701), x = i(7261), w = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return Object.defineProperty(t, "_dataGrouped", {
                        enumerable: !0,
                ...
                return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                    ...
                    value: function (t, i, a, n) {
                        ...
                        if (this.setRaw("maxPrecision", 0), "millisecond" == h || "second" == h || "minute" == h || "hour" == h) {
                            ...
                            var c = i - t;
                            0 === c && (c = Math.abs(i));
                            var p, b = [60, 30, 20, 15, 10, 2, 1], g = 1;
                            ...
                            var y = Math.ceil((i - t) / g / a), _ = Math.log(Math.abs(y)) * Math.LOG10E,
                                x = Math.pow(10, Math.floor(_)) / 10, w = y / x;
                    ...
                    value: function (e) {
                        var t = this.getDurationFormatter(), i = this.get("extraTooltipPrecision", 0),
                            a = this.getPrivate("stepDecimalPlaces", 0) + i, r = d.round(this.positionToValue(e), a);
            ...
            }(P.JH), T = i(6293), D = i(9084), j = i(4714), A = i(8943), k = i(6275), I = i(6284), M = i(7909), C = i(4604),
            Y = i(2976), X = i(2312), S = function (e) {
                function t() {
                    return null !== e && e.apply(this, arguments) || this
                }
            ...
            }(Y.j), F = i(5769), N = i(7144), R = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return Object.defineProperty(t, "columns", {
                        enumerable: !0,
                        configurable: !0,
                        writable: !0,
                        value: new N.o(F.YS.new({themeTags: ["autocolor"]}), (function () {
                            return S._new(t._root, {themeTags: s.mergeTags(t.columns.template.get("themeTags", []), ["ohlc", "series", "column"])}, [t.columns.template])
                        }))
                    }), t
                }
                ...
                return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "makeColumn", {
                    ...
                    value: function (t) {
                        ...
                        e.prototype._processAxisRange.call(this, t), t.columns = new N.o(F.YS.new({}), (function () {
                            return S._new(i._root, {themeTags: s.mergeTags(t.columns.template.get("themeTags", []), ["ohlc", "series", "column"])}, [i.columns.template, t.columns.template])
                        }))
                    }
                }), Object.defineProperty(t, "className", {
                    enumerable: !0,
            ...
            }(X.$), L = i(62), V = i(2338), G = i(5892), U = function (e) {
                function t() {
                    return null !== e && e.apply(this, arguments) || this
                }
            ...
            return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                ...
                enumerable: !1, configurable: !0, writable: !0, value: function (e, t) {
                    ...
                    if (this._shouldInclude(l)) {
                        var p = this.getPoint(l, u), b = [p.x, p.y], d = this.getPoint(h, c), g = [d.x, d.y];
                        if (t.fillVisible) {
                            var f = l, m = u, v = h, y = c;
                            if (t.baseAxis === t.xAxis ? (m = t.basePosY, y = t.basePosY) : t.baseAxis === t.yAxis && (f = t.basePosX, v = t.basePosX), t.getOpen) {
                                var _ = e.get(t.xOpenField), x = e.get(t.yOpenField);
                                if (null != _ && null != x) if (o = r = e.get("openLocationX", t.openLocationX), s = n = e.get("openLocationY", t.openLocationY), t.baseAxis === t.xAxis ? (r -= a, o += a) : t.baseAxis === t.yAxis && (n -= a, s += a), t.stacked) {
                                    var w = e.get("stackToItemX"), P = e.get("stackToItemY");
                            ...
                            var O = this.getPoint(f, m), T = this.getPoint(v, y);
